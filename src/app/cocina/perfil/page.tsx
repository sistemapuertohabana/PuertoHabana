    ...
    <div className="animate-in fade-in duration-300 max-w-3xl mx-auto pb-20 lg:pb-0">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
        ...
        <div className="px-8 pb-8 relative">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900">Carlos Rodríguez</h2>
            <p className="text-orange-600 font-medium">Jefe de Cocina</p>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900">cocina.jefe@puertohabana.pe</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900">Completo (10:00 - 22:00)</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900">1 de Marzo, 2024</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900">Marina & Criolla</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-100">
            ...
            <div className="bg-gray-50 rounded-xl p-5 border border-gray-200 flex justify-between items-center">
              <div>
                ...
                <p className="text-xl font-bold text-gray-900">S/ 3,500.00</p>
              </div>
              <div className="text-right">
                <p className="text-xs text-gray-500 font-medium">Bonos (Mes actual)</p>
                <p className="text-xl font-bold text-green-600">+ S/ 250.00</p>
              </div>
            </div>
          </div>
        </div>
