...
import { ChefHat, ArrowLeft, Mail, Loader2, LogIn } from 'lucide-react';
...
export default function LoginCocinaPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-50 via-orange-50 to-white p-4 relative overflow-hidden">
      {/* Fondo decorativo */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-32 -right-32 w-96 h-96 bg-orange-100/40 rounded-full blur-3xl" />
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl border border-gray-100 overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
          {/* Header */}
          <div className="bg-gradient-to-r from-orange-600 to-amber-500 px-8 pt-8 pb-12 relative">
            ...
            <div className="relative">
              ...
              <h1 className="text-2xl font-bold text-white">Acceso Cocina</h1>
              <p className="text-orange-100 text-sm mt-1">Puerto Habana Cevicheria</p>
            </div>
          </div>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="ej: cocina@gmail.com  o  Luis"
                    autoComplete="off"
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500/30 focus:border-orange-500 focus:outline-none text-sm transition-all duration-200 bg-gray-50/50 focus:bg-white"
                  />
                ...
                <button type="submit" disabled={loading}
                  className="w-full bg-gradient-to-r from-orange-600 to-amber-500 text-white font-bold py-3.5 rounded-xl hover:from-orange-700 hover:to-amber-600 transition-all duration-200 disabled:opacity-60 text-sm flex items-center justify-center gap-2 shadow-lg shadow-orange-200 hover:shadow-orange-300 active:scale-[0.98]">
                  {loading ? (
                    <Loader2 size={18} className="animate-spin" />
                  ) : (
                    <><LogIn size={16} /> Entrar a Comandas</>
                  )}
                </button>
              </form>
            </div>
