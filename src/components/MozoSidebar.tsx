...
import { LayoutGrid, User, LogOut, ListOrdered, CalendarClock, Settings, DollarSign, Moon, Sun } from 'lucide-react';
        ...
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full overflow-hidden border-2 bg-gray-100 border-gray-200 flex items-center justify-center">
              <ProfileAvatar photo={photo} fallback={<LayoutGrid size={18} className="text-gray-400" />} />
            </div>
            <div>
              <p className="text-sm font-semibold leading-none text-gray-900">Portal Mozo</p>
